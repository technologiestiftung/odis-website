...
description: Der Großteil aller Verwaltungsdaten hat einen geographischen Bezug. Das können Adressen sein oder Informationen, die sich auf bestimmte Räume wie Bezirke beziehen. Um die Nutzung zu erleichtern, sollten diese Daten um Koordinaten ergänzt werden. Das Video-Tutorial zeigt, wie das automatisiert gelingt.
question: Wie können Daten um Geokoordinaten ergänzt werden? 
media:
  thumbnail: ./images/youtube-kacheln_geocodierung.png
  type: video
  readingOrPlayingTime: 16 Minuten
  link: https://www.youtube.com/embed/96ZgMLkpD8c
---
...
<VideoEmbed 
fullWidth={false}
url="https://www.youtube.com/embed/96ZgMLkpD8c" 
...
Wenn Sie den geocodierten Datensatz veröffentlichen, zum Beispiel im [Berliner Open Data Portal](https://daten.berlin.de/), geben Sie in den Metadaten das Koordinatenbezugssystem an, in welches Sie geocodiert haben. So stellen Sie sicher, dass die Daten richtig weiterverwendet werden können.
