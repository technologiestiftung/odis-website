...
description: Metadaten eines Datensatzes beschreiben die eigentlichen Daten. Sie sind ein wichtiger Bestandteil jeder Veröffentlichung von Daten im Datenportal, denn ohne qualitative Metadaten kann weder die Transparenz noch eine nachhaltige Verwendbarkeit der Daten garantiert werden. Die Vorlage hilft bei der Erfassung.
question: Welche Infos werden für eine Veröffentlichung benötigt? 
media:
...
## Die Vorlage für Metadaten im Berliner Datenportal
