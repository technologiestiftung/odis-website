...
description: Wie wähle ich effektive Tags als Datenbereitsteller:in?
question: Wie veröffentliche ich Open Data?
media:
  thumbnail: ./images/tag_analyse_resource.webp
  type: project
  link: /projekte/tag_analyse
---

Wie in unserem [Leitfaden](/ressourcen/metadaten) erklärt, spielen Metadaten u.a. eine wichtige Rolle bei der Nutzbarkeit und Auffindbarkeit von offenen Daten. Im Falle der Auffindbarkeit, sind die sogenannten Tags (auch als Schlüsselwörter bekannt) besonders kritisch.
...
import image from "../../projekte/tag_analyse/images/tag_analyse.png"

<ProjectEmbed
  project="tag_analyse"
  image={image}
  buttonText="Zur Analyse"
