...
tags:
  ...
  - home
date: 2023-01-31
title: Video-Tutorial zur Veröffentlichung von Daten über das Datenregister
description: "Das Berliner Datenportal macht Datenbestände der Berliner Verwaltung für die Öffentlichkeit an zentraler Stelle auffindbar. Wie Daten im Portal veröffentlicht werden, zeigt das Video-Tutorial." 
question: Wie werden Daten im Berliner Datenportal veröffentlicht? 
media:
  thumbnail: ./images/youtube-kacheln_veröffentlichung.png
  type: video
  readingOrPlayingTime: 13 Minuten
  link: https://www.youtube.com/embed/z-x0of0HEkk
---
...
1. Zum einen gibt es das öffentlich sichtbare, eigentliche Portal, das unter [daten.berlin.de](https://daten.berlin.de) zu erreichen ist. Über diese Webseite kann jede:r Interessierte, egal ob aus Verwaltung, Wissenschaft, Wirtschaft, Presse oder Zivilgesellschaft, die Berliner Open-Data-Bestände durchsuchen.

2. Parallel existiert das nicht-öffentliche Datenregister. Bei diesem handelt es sich gewissermaßen um das Redaktionssystem des Datenportals, über das Verwaltungsmitarbeiter:innen Datensätze einstellen oder existierende Einträge ändern können. Es ist unter [datenregister.berlin.de](https://datenregister.berlin.de) erreichbar.
...
<VideoEmbed
  fullWidth={false}
  url="https://www.youtube.com/embed/z-x0of0HEkk"
