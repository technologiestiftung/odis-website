...
- GeoJSON-Export: Der Datensatz kann in der verbreiteten Projektion WGS 84 (EPSG:4326) als GeoJSON-Datei exportiert und damit direkt in anderen Anwendungen weiterverwendet werden.
