...
Doch obwohl WFS-Dienste technisch leistungsfähig sind, ist ihr direkter Zugang oft wenig intuitiv. Ohne spezielles Fachwissen oder geeignete Software wie Geographische Informationssystemen (GIS) ist es für viele Nutzer:innen schwer, die Informationen zu verstehen und für sich zu nutzen.
...
## WFSExplorer: Geodaten auf einem Blick
...
Zusätzlich kann der Link zum WFS-Dienst mit den Explorationsergebnissen schnell geteilt werden. 
