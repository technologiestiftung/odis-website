...
description: Eine Anwendung, die die Gehwegbreiten in Berlin visualisiert
date: 2020-05-06
period: Mai 2020
status: abgeschlossenes Projekt
visible: true
heroImage: ./images/gehwegbreiten_desktop_visual_n.png
mobileImage: ./images/gehwegbreiten_mobile_visual_n.png
showImageInMockup: true
projectUrlWithoutProtocol: "gehwege.citylab-berlin.org"
gitHubLink: https://github.com/technologiestiftung/berlin_sidewalk_widths
datasets:
  - linkText: Datensatz der Gehwegbreiten basierend auf Gehwegpositionen aus „Straßenbefahrung“ der Senatsverwaltung für Umwelt, Verkehr und Klimaschutz Berlin (2014)
...
import logo from "./images/logo_stadt_berlin.png";

<Quote authorName="Daten.Berlin" authorLogo={logo}>
  Die Berliner Gehwegbreiten-Karte zeigt, in welchen Kiezen es schnell eng
  werden kann.
</Quote>
