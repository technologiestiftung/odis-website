...
tags:
  ...
  - "project"
  - "post"
title: Dashboard Stadtbibliothek Pankow
...
status: Aktives Projekt, das jährlich mit aktuellen Bibliotheksdaten aktualisiert wird.
...
datasets:
  - linkText: Bibliotheksdaten aller Pankower Bibliotheken 
    link: https://daten.berlin.de/datensaetze/ausleihen-%C3%B6ffentlichen-bibliotheken-pankow-2022
