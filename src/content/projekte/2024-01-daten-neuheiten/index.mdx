...
visible: true
heroImage: ./images/daten_neuheiten.png
...
<iframe
  title="Neuerscheinungen und Updates in den letzten zwei Wochen auf Berlin Open Data"
  ...
  data-external="1"
></iframe>
Die Tabelle wird täglich aktualisiert und zeigt alle Änderungen der letzten zwei
Wochen. Dank einer einfachen Farbkodierung lassen sich Neuerscheinungen und
Aktualisierungen schnell und unkompliziert erkennen. Ein Klick auf den Titel
eines Datensatzes führt Sie direkt zur entsprechenden Seite auf dem Datenportal.
...
<iframe
  title="Neuerscheinungen und Updates seit dem Jahr 2000 auf Berlin Open Data"
