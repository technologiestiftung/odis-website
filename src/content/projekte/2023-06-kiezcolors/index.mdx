...
<Quote
  authorName="Geo Observer"
  authorLogo={logo}
>
  Die Open Data Informationsstelle (ODIS) und CityLAB Berlin haben mit Kiezcolors eine wunderbare, einfach zu bedienende interaktive Webanwendung ins Netz gestellt, mit welcher man ganz schnell für jede Lokation in Berlin die Flächennutzung im Umkreis von 1.000m ermitteln kann.
</Quote>
