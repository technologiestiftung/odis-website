...
gitHubLink: https://github.com/technologiestiftung/emotionskarte_frontend
...
Die im Rahmen des Projekts entwickelte Karte ermöglicht einen Einblick in die gesammelten Daten und macht sichtbar, wie Menschen verschiedene Orte der Stadt emotional erleben.
...
<ImageSection
    src={image1}
    caption="Öffentliche Vorstellung des Projekts im Futurium durch die Doktorandin Sephira Kolbe."
/>
...
Die auf der Karte dargestellten Fotos der Landmarken stammen nicht aus der Datenerhebung innerhalb der App. Es handelt sich dabei nicht um von den Teilnehmenden aufgenommenes Bildmaterial, sondern um extern bezogene Abbildungen aus [Wikidata](https://www.wikidata.org/wiki/Wikidata:Main_Page), beziehungsweise den dort verknüpften Medienquellen. Die jeweiligen Lizenzinformationen sowie Angaben zu Autor:innen (sofern verfügbar) werden transparent im jeweiligen Bild-Popup angezeigt, das beim Anklicken der Fotos geöffnet werden kann.
