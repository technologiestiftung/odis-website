...
import logo from "./images/B_SEN_WiGeP_Logo_DE_V_PT_RGB.svg";

<Quote
  authorName="William Treherne"
  authorRole="Open Data Beauftragter der Senatsverwaltung für Wissenschaft, Gesundheit und Pflege"
  authorLogo={logo}
>
