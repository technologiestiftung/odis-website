...
description: Ideation für eine interaktive Visualisierung offener Finanzdaten zu bezirklichen Ausgaben
date: 2022-03-28
period: Jahr 2022
status: abgeschlossen
visible: true
heroImage: ./images/waskostetwo_alternativ_desktop_visual.png
partners:
...
## Von der PDF zur Storytelling-Anwendung

Informationen darüber bereitzustellen, [wo wieviel öffentliche Gelder ausgegeben werden](https://www.berlin.de/sen/finanzen/haushalt/downloads/artikel.6347.php), ist ein wichtiger Aspekt im Sinne einer transparent agierenden Verwaltung. Die Senatsverwaltung für Finanzen (SenFin) veröffentlicht daher seit dem Jahr 2000 jährlich die Broschüre [„Was kostet wo wie viel?”](https://www.berlin.de/sen/finanzen/haushalt/downloads/wkwwv_hv_2017.pdf) zum Download im Internet. Darin werden auf knapp 70-PDF-Seiten Verwaltungskosten aufgeschlüsselt nach Bezirken und Fachbereichen dargestellt.
...
import image1 from "./images/broschüre.png";

<ImageSection
  src={image1}
  caption="Ausschnitt aus der PDF-Broschüre 'Was kostet wo wie viel?'"
/>
...
import image2 from "./images/wireframe_1.png";

<ImageSection src={image2} withShadow={true} />

import image3 from "./images/wireframe_2.png";

<ImageSection src={image3} withShadow={true} />

import image4 from "./images/wireframe_3.png";

<ImageSection
  src={image4}
  withShadow={true}
  caption="Wireframe-Ausschnitte der interaktiven Datenvisualisierungen"
/>
