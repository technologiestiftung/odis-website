...
<Quote
  authorName="Projekt Zukunft"
  authorLogo={logo}
>
So versucht die Informationsstelle die Daten in einer attraktiven und ansprechenden Form aufzubereiten. Dazu entwickeln sie eigene und praxisnahe Anwendungen.
</Quote>