...
description: Interaktive Kartenanwendung zum Thema Badestellen und aktuelle Wasserqualität in Berlin
date: 2019-11-09
...
datasets:
  - linkText: Berliner Badestellen und Messungen (Datensatz wird nur zur Badesaisons 15. Mai - 15. September aktualisiert)
...
<Quote authorName="Projekt Zukunft" authorLogo={logo}>
  So versucht die Informationsstelle die Daten in einer attraktiven und
  ansprechenden Form aufzubereiten. Dazu entwickeln sie eigene und praxisnahe
  Anwendungen.
</Quote>
