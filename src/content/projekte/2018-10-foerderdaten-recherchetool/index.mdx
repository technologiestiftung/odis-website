...
import logo from "./images/logo_vdz.png";

<Quote
  authorName="Verwaltung der Zukunft"
  authorRole="Das Fachportal für das moderne und digitale Deutschland"
  authorLogo={logo}
>
  Nicht nur die Medien, sondern auch interessierte Bürger und Organisationen aus der Zivilgesellschaft können nunmehr auf ein einfach gehaltenes Recherche-Instrument zugreifen, das anschauliche Ergebnisse liefert.
</Quote>