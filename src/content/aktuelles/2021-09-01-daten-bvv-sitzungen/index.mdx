...
title: Daten zu BVV-Sitzungen als Open Data
description: Seit Juli diesen Jahres veröffentlichen die ersten Bezirke
...
Die meist vertretenen Rollen sind die des Ausschussmitglieds (34%) und des stellv. Ausschussmitglieds (17%). Fraktionsmitglieder und Bürgedeputierte machen jeweils 8% der Beteiligten aus.
...
<ContentSection fullWidth={true}>
  <iframe
    src="https://evelyne-brie.shinyapps.io/ALLRIS_Share/"
    width="100%"
    height="500px"
    title="My file"
    loading="lazy"
...
import Allris from "@/components/pageSpecific/Allris.astro";
...
<ContentSection fullWidth={true}>
  <iframe
    src={`${import.meta.env.SITE}/extra-pages/allris/allris_streets/`}
    width="100%"
    height="600px"
    title="My file"
    loading="lazy"
