...
description: Offene Daten bilden die Grundlage von Anwendungen wie
  ...
  die Berliner Tarifkarte vor; eine Visualisierung der ODIS, die räumlichen
  Ausdehnungen verschiedener Tarifzonen des Berliner ÖPNV beleuchtet.
categories: aktuelles
visible: true
urlText: Zum Blogbeitrag
headerImage:
  src: ./images/tarifkarte.png
  alt: Tarifkarte
date: 2023-03-30
---
...
<ContentSection>
  <iframe
    loading="lazy"
    src="https://tarifkarte.odis-berlin.de/"
