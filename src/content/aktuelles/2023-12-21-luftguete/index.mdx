...
description: Seit Mai 2022 übermittelt die zuständige SenMVKU Luftgütemessdaten über eine offene API-Schnittstelle an das Berliner Open-Data-Portal. Wir haben uns intensiv mit den Daten beschäftigt und beispielhaft aufgezigt wie die API abgefragt werden kann, um mit den Luftgütedaten zu arbeiten.
...
<ContentSection caption="Übersicht von Kraftwerken im Berliner Stadtgebiet" fullWidth={false}>
  <iframe 
