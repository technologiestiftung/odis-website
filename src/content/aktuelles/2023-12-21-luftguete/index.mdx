...
description: Seit Mai 2022 übermittelt die SenMVKU Luftgüte-Messdaten über eine offene API-Schnittstelle ans Berliner Open-Data-Portal. Wir haben uns mit den Daten beschäftigt und beispielhaft aufgezeigt wie die API abgefragt wird, um mit Luftgütedaten zu arbeiten.
