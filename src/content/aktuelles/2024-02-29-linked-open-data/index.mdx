...
Ein Beispiel für eine existierende Ontologie die häufig zur Beschreibung von Personen verwendet wird, heißt “Friend of a Friend” (kurz: *foaf*).

Ein [Webeintrag](http://xmlns.com/foaf/spec/) beschreibt, wie die Ontologie benutzt wird und bietet einen Überblick über ihre Begriffe, also Beziehungen und Informationen, die mit ihrem Vokabular abgebildet werden können. Bei *foaf* sind das zum Beispiel die Namen, Anschrift, Kontaktmöglichkeiten oder innegehaltenen Positionen einer jeweiligen Person. Die Ontologie stellt somit URIs bereit, die benötigt werden, um Informationen als Triples auszudrücken.
...
Das Organigramm-Tool ermöglicht es also Daten im RDF-Format und Verwendung von Standards zu erstellen und herunterzuladen. Um zu echten Linked Open Data zu kommen, gilt es noch einen Schritt weitergehen, nämlich die Daten im Internet verfügbar machen, so dass sie abgefragt und mit externen Daten verlinkt werden können. 
...
Um die Informationen eines Triple Stores abzufragen, gibt es die Abfragesprache: SPARQL ermöglicht es, komplexe Abfragen über die gespeicherten Informationen im Triple Store auszuführen.

### TBD/Review ab hier

Ein SPARQL-Code zur Abfrage von Informationen über eine Person, z.B. den Bürgermeister Kai Wegener könnte wie folgt aussehen:
...
** Screenshot, Link zum SPARQL-Endpunkt **
...
## TBD: Zusammenfassung und Ausblick
...
Bei Fragen oder Feedback zum Tool oder Vorgehen, freuen wir uns über einen Austausch, genauso wie über Ideen für mögliche Linked Open Data Anwendungen. Wir wollen den Weg zu den 5* Sternen im Austausch mit der Community und Verwaltung gehen und laden dazu ein gemeinsame neue Ansätze und Pfade zu erkunden und Wissensschätze zu sammeln, um das Thema Datenmanagement und Dateninfrastruktur in Berlin zielgerichtet voranzubringen!
