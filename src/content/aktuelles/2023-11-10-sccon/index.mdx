...
description: Wenn sich auf der SCCON Expert:innen und Aussteller:innen aus der Verwaltungsmodernisierung und -digitalisierung zusammenfinden, kommt man am Thema Open Data nicht vorbei. Ob auf Panels zu Smart City oder in einzelnen Open-Data-Formaten, zunehmend wird esdeutlich, dass in der Verwaltung ein enomer Datenschatz schlummert, den es zu befreien gilt, als Grundlage für Smart City & KI-Anwendungen und zur Stärkung von Transparenz und demokratischen Strukuren. Wir waren auf der SCCON und berichten von unseren Highlights.
