...
Mit unserem [Organigramm-Tool](https://organigramme.odis-berlin.de) können nun Organigramme erstellt und Informationen in maschinenlesbarer Form und seit der letzten Entwicklungsstufe auch in einem Linked Open Data fähigen Format veröffentlicht werden. So können die Informationen aus der grafischen Darstellung herausgezogen und für vielfältige Anwendungen genutzt werden, etwa für die Suche nach Personen in Führungspositionen über die gesamte Verwaltung. Um sicherzustellen, dass Maschinen oder Software keine falschen Informationen erhalten, ist es jedoch unerlässlich, eine möglichst einheitliche Sprache bei der Erstellung der Organigramme zu verwenden.
...
import image2 from "./images/IMG_8207.jpg"

<ContentSection class="sm:px-6">
<ImageSection class="sm:container sm:mx-auto"
src={image2}
caption="Maike Mehrlaender von der SenWGP und Betül Özdemir, Zentrale Verantwortliche für Open Data in der Senatskanlzei sind mit guter Laune und motiviert dabei."
/>
</ContentSection>

import image3 from "./images/IMG_8261.jpg"

<ImageSection
src={image3}
caption="Ein ODIS-Teammitglied stellt den Workshop-Teilnehmenden das Organigramm-Tool vor."
/>
...
<ImageSection class="sm:container sm:mx-auto"
src={image4}
caption="Julia Schabos von der SenFIN greift zur Schere und filitiert das Organigramm der SenFIN."
/>
</ContentSection>
...
<ImageSection
src={image5}
caption="Gemeinsam disktutieren wir die nächsten Schritte."
/>
