...
tags:
  - "post"
title: "ODIS auf der FOSSGIS – Open Source & Open Data"
description: Vom 15.-17. März 2023 fand an der Humboldt Universität in Berlin
...
headerImage:
  src: ./images/fossgis.png
  alt: Klemens, Anna und Ester auf der Fossgis
date: 2023-03-29
---
...
import image1 from "./images/fossgis2023_open-data-talk.jpg"

<ImageSection
  src={image1}
  caption="Projektleiterin Lisa Stubert spricht über Open Data in Berlin"
/>
...
import image2 from "./images/fossgis2023_panel.jpg"

<ImageSection
  src={image2}
  caption="Victoria Boeck neben anderen Expert:innen auf dem Panel zu öffentlichen Ausschreibungen mit FOSS"
/>
...
import image3 from "./images/fossgis2023_xhain-parkplatzdaten.png"

<ContentSection class="px-6">
  <ImageSection
    src={image3}
    caption="Parkplatzdaten aus OpenStreetMap im Geodatenportal von Friedrichshain-Kreuzberg"
  />
</ContentSection>
...
import image4 from "./images/fossgis2023_tsb-stand.jpg"

<ImageSection
  src={image4}
  caption="Lisa Stubert und Simon Scholler von der Technolgiestiftung Berlin in einem Gespräch an unserem Stand"
/>
