...
Here möchten wir anhand eines Beispiels illustrieren, wie der Zugang und eine Übersicht zu den Daten mittels des MCP-Servers schnell erfolgen kann. Wir nutzen den MCP in der Weboberfläche von Mistral und fragen: "In welchem Bezirk in Berlin werden die meisten Fahrräder gestohlen?"
