...
description: Das Thema Open Data wechselt in der Verwaltung die
...
headerImage:
  src: ./images/gruppenfoto_kleindiek.jpg
...
import image from "./images/Odis_meets_CDO.png"

<ImageSection
  src={image}
  caption="Gleich getwittert: Das gemeinsame Gruppenfoto im Büro des CDO"
  withShadow
/>
