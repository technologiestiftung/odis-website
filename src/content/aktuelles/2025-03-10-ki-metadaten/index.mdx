...
Im nächsten Schritt geben wir den behördlichen Beauftragten für Open Data die vorgefilterten Ergebnisse der Metadatenqualitäts-Bewertung und der KI-Begründung (die auch als Verbesserungsvorschläge funktionieren) der Datensätze im Open Data Portal sowie ein Handout als Hilfestellung zur Verbesserung der Metadaten mit. So können die Beauftragten "ihre" Metadateneinträge sichten und verbessern. 
