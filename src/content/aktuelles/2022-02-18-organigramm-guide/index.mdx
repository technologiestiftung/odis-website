...
Unter _Exportieren_ werden Ihnen verschiedene Dateiformate zur Auswahl gestellt. Wählen Sie testweise _PDF_ und _Bitmap_ und klicken Sie auf den Button exportieren um ein PDF herunterzuladen.
