...
<ContentSection class="sm:px-20 w-full h-auto">
  <div style="position: relative; padding-bottom: 56.25%; width: 100%; height: 0;">
    <iframe 
      title="Standorte von Schnellimbissen in Berlin" 
      aria-label="Locator-Karte" 
      id="datawrapper-chart-wKqEk" 
      src="https://datawrapper.dwcdn.net/wKqEk/3/" 
      scrolling="no" 
      frameborder="0" 
...
<ContentSection class="sm:px-20 w-full h-auto">
  <div style="position: relative; padding-bottom: 56.25%; width: 100%; height: 0;">
    <iframe 
      title="Standorte von Schnellimbissen in Berlin" 
      aria-label="Locator-Karte" 
      id="datawrapper-chart-ouXj9" 
      src="https://datawrapper.dwcdn.net/ouXj9/1/" 
      scrolling="no" 
      frameborder="0" 
      style="border: none; position: absolute; top: 0; left: 0; width: 100%; height: 100%;" 
      data-external="1">
