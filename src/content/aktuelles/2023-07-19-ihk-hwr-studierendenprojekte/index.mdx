...
description: Die IHK Berlin hat Studierende des Masterstudiengangs Digitale
...
headerImage:
  src: ./images/Bienen_IHK.jpg
  alt: Student:innen der HWR stellen Projekte auf ein Screen vor
author: Lisa Stubert
date: 2023-07-19
---
...
import image1 from "./images/datalunchr.jpg"

<ImageSection
  src={image1}
  caption="Wie können Unternehmer:innen einen geeigneten Standort finden? Die Projektgruppe gibt Einblick in ihr Tool"
/>
...
import image2 from "./images/Bienen_IHK.jpg"

<ImageSection
  src={image2}
  caption="Ein Kartentool für das Potenzial von Flachdächern, vorgestellt von Studierenden der HWR"
/>
...
import image3 from "./images/Scoring_IHK.jpg"

<ImageSection
  src={image3}
  caption="Verschiedene Faktoren können für die Standortwahl wichtig sein. Mithilfe eines Datenanalyseskripts, das die Studierenden entwickelt haben, können Stadtgebiete analysiert und erste Bewertungen vorgenommen werden"
/>
